...
exports.mariaDbGatoRepository = exports.MariaDbGatoRepository = void 0;
const databaseMariaDB_1 = __importDefault(require("../../config/databaseMariaDB"));
function toGatoResponse(row) {
...
class MariaDbGatoRepository {
    ...
    async create(data) {
        const result = await this.database.query('INSERT INTO gatos (nomeGato, idadeGato, pesoGato, peloGato, racaGato, idIcone, tutor_id) VALUES (?, ?, ?, ?, ?, ?, ?)', [data.nomeGato, data.idadeGato, data.pesoGato, data.peloGato, data.racaGato, data.idIcone, Number(data.tutor_id)]);
...
exports.mariaDbGatoRepository = new MariaDbGatoRepository();
